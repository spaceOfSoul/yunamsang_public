...
document.addEventListener("DOMContentLoaded", (event) => {
    const muteAudioField = document.getElementById("mute_audio_inp");
    const muteVideoField = document.getElementById("mute_video_inp");
...
function validate() {
    if (!camera_allowed) { alert("Please allow camera and mic permissions!"); }
